...
def parse_opt(known=False):
    ...
    parser.add_argument("--cfg", type=str, default=ROOT /"drogue/drogue_model5s.yaml", help="model.yaml path")
    parser.add_argument("--data", type=str, default=ROOT / "drogue/drogue_parameter.yaml", help="dataset.yaml path")
    ...
    parser.add_argument("--project", default=ROOT / "runs/train", help="save to project/name") #结果保存文件夹
